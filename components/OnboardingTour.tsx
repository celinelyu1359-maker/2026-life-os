...
const OnboardingTour: React.FC<OnboardingTourProps> = ({ isOpen, onClose }) => {
  ...
  const steps = [
    {
      title: "Welcome to 2026 Life OS",
      description: "Monthly Theme这个东西我的初衷就是希望以月为单位去建立一个习惯或者加速某个爱好的成长，让平凡的生活有趣一些。",
      icon: <Calendar className="w-12 h-12 text-indigo-500" />,
      color: "bg-indigo-50"
    },
    {
      title: "Smart Todo List",
      description: "我们的todo list是有delay功能的，可以延续到下个周期。不再为未完成的任务感到焦虑，灵活调整你的节奏。",
      icon: <Clock className="w-12 h-12 text-blue-500" />,
      color: "bg-blue-50"
    },
    {
      title: "Life Dimensions",
      description: "Life Dimensions里面我们支持拆分目标，写完成情况，做可视化追踪。让每一个大目标都变得触手可及。",
